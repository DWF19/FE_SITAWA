...
const PopUpPerangkat = () => {
  ...
  return (
    <div className="">
       <div
          className={`flex justify-center items-center gap-3 shadow-2xl rounded-md bg-white border py-2 px-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 ${
            state.actionHapusPerangkat ? "" : "hidden"
