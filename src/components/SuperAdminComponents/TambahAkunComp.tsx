...
const TambahAkunComp = () => {
  ...
  const mutation = useHandleRegist();
            ...
            <div className="mt-[77px] flex items-center justify-center">
              <form onSubmit={handleRegister} className="block r">
                ...
                <div className="flex items-center justify-center mt-5 mb-10">
                  ...
                  <div className={`w-[216px] h-[40px] mb-10 bg-custom-gradient rounded-full flex items-center justify-center ${
