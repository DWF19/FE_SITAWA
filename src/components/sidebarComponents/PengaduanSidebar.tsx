...
const PengaduanSidebar:React.FC<propsFromBeranda> = ({bg}) => {
    ...
    <div>
        ...
        <div className="pt-36">
          <div className="w-[290px] ">
            <div onClick={() => navigate('/dashboard')} className={`flex items-center gap-3 mb-5  w-[273px]  h-[54px] rounded-r-[50px] cursor-pointer`}>
            ...
            {/* icon 2 ------- */}
            <div onClick={() => navigate('/pengaduan-masyarakat')} className={`flex items-center gap-3 mb-5 w-[273px] h-[54px] rounded-r-[50px] cursor-pointer ${bg}`}>
              <span className="icon2 ml-10">
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor="#9BEC00" />
                      <stop offset="1" stopColor="#06D001" />
                    </linearGradient>
                    <linearGradient
              ...
              <p className="text-white text-[12px] mr-7">
                Pengaduan Masyarakat
              </p>
            </div>
            {/* icon 3 ------- */}
            <div onClick={() => navigate('/perangkat-kecamatan')} className="flex items-center gap-3 mb-5 w-[273px] h-[54px] rounded-r-[50px] cursor-pointer">
              ...
              <p className="text-[#858585] text-[12px] mr-7">Perangkat Kecamatan</p>
              {/* icon 4 ------- */}
            </div>
                ...
                >
                  ...
                  <defs>
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stopColor="#9BEC00" stopOpacity="0.8" />
                      <stop offset="1" stopColor="#06D001" />
                    </linearGradient>
                    <linearGradient
...
export default PengaduanSidebar