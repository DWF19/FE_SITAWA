    ...
    <div>
        ...
        <div className="pt-36">
          <div className="w-[290px] ">
            <div onClick={() => navigate('/dashboard')} className={`flex items-center gap-3 mb-5 ${bg} w-[273px]  h-[54px] rounded-r-[50px] cursor-pointer`}>
              ...
              <p className="text-white text-[12px] mr-7">Dashboard</p>
            </div>
            {/* icon 2 ------- */}
