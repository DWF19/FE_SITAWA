...
const LaporanProduksiKecComp = () => {
  ...
  useEffect(() => {
    if (isLoading) {
      ...
      if (Number(sessionStorage.getItem("id")) !== Number(data?.user_id)) {
        navigate("/404");
      }
    }
  }, [data?.user_id]);
        ...
        <div className="border rounded-lg my-10 shadow-md">
          ...
          <div className="flex justify-center items-center">
            <div className="w-[95%] flex justify-between items-center mt-14 mb-10 text-[14px]">
              <div className="flex gap-5">
                <div>
                  {["PROVINSI", "KABUPATEN", "KECAMATAN"].map((item,index) => {
          ...
          <div className="flex justify-center items-center">
            <div className="border w-[500px] my-10 p-5 shadow-md rounded-md">
              <p className="text-center pb-10 font-bold invisible">
                empty space
              </p>
...
export default LaporanProduksiKecComp;
